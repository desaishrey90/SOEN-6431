...
namespace LinqCommerce
{
    ...
    {
        LinqShoppingOrderAccess objLinqShoppingOrderAccess = new LinqShoppingOrderAccess();
        #region Properties
        /// <summary>
        ...
        */
        ...
        {
            objLinqShoppingOrderAccess.DoProductInventory();
            //LinqCommerceDataContext db = new LinqCommerceDataContext();
        ...
        {
            return objLinqShoppingOrderAccess.CheckProductInventory(Quantity, ProductID, Size, Color);
        ...
        {
            return objLinqShoppingOrderAccess.AddShipping(RegionName);
            //LinqCommerceDataContext db = new LinqCommerceDataContext();
        ...
        {
            return objLinqShoppingOrderAccess.AddTax(UserState);
            //LinqCommerceDataContext db = new LinqCommerceDataContext();
        ...
        {
            return objLinqShoppingOrderAccess.AddTaxShipAmount();
        ...
        {
            objLinqShoppingOrderAccess.CreateOrderDetail(OrderID, CouponCode, UserName);
            ////Get all carts
            //LinqCommerceDataContext db = new LinqCommerceDataContext();
        ...
        {
            return objLinqShoppingOrderAccess.CreateOrder();
            //LinqCommerceDataContext db = new LinqCommerceDataContext();
        ...
        {
            return LinqShoppingOrderAccess.GetShoppingCartID();
        ...
        {
            return LinqShoppingOrderAccess.GetMoneyCoupon(CouponName);
            //LinqCommerceDataContext db = new LinqCommerceDataContext();
        ...
        {
            return LinqShoppingOrderAccess.GetPercentCoupon(CouponName);
            //LinqCommerceDataContext db = new LinqCommerceDataContext();
        ...
        {
            return LinqShoppingOrderAccess.GetTotalAmount(cartID);
            //LinqCommerceDataContext db = new LinqCommerceDataContext();
        ...
        {
            return LinqShoppingOrderAccess.CheckCoupon(CouponName);
        ...
        {
            return LinqShoppingOrderAccess.ProfileCheck(BillingFirstName);
            //if (BillingFirstName == "")
            //{
            //    return false;
        ...
        {
            return LinqShoppingOrderAccess.ShowPaymentForm(amount);
