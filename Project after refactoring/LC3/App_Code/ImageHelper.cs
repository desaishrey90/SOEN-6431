    ...
    public class ImageResize
    {
        ...
        public virtual Image GetThumbnail()
        {
            ...
            if (!IsSameDstImage(m_cache))
            {
                ...
                if (UsePercentages)
                {
                    ComputeDimensionsByPercentage(ref new_width, ref new_height);
                }
                else
                {
                    ...
                    if (PreserveAspectRatio)
                    {
                        ...
                        ComputeDimensionsByAspectRatio(ref new_height, ref new_width);
                    }
                }
        ...
        private void ComputeDimensionsByAspectRatio(ref double new_height, ref double new_width)
        {
        ...
        private void ComputeDimensionsByPercentage(ref double new_width, ref double new_height)
        {
            if (Width != 0)
            {
