...
namespace LinqCommerce
{
    ...
    public class LinqOrderAccess
    {
        ...
        //}
        public void InsertBilling(BillingInformation Billing)
        {
            LinqCommerceDataContext db = new LinqCommerceDataContext();

            lc_BillingInfoTable bi = new lc_BillingInfoTable();
            bi.FirstName = Billing.getFirstName();
            bi.LastName = Billing.getLastName();
            bi.MiddleName = Billing.getMiddleName();
            bi.NickName = Billing.getNickName();
            bi.OrderID = Billing.getOrderID();
            bi.Phone = Billing.getPhone();
            bi.Prefix = Billing.getPrefix();
            bi.State = Billing.getState();
            bi.Zip = Billing.getZip();
            db.lc_BillingInfoTables.InsertOnSubmit(bi);
            db.SubmitChanges();
        ...
        //}
        public void InsertShipping(ShippingInformation Shipping)
        {
            LinqCommerceDataContext db = new LinqCommerceDataContext();
            lc_ShippingInfoTable bi = new lc_ShippingInfoTable();
            bi.FirstName = Shipping.getFirstName();
            bi.LastName = Shipping.getLastName();
            bi.MiddleName = Shipping.getMiddleName();
            bi.NickName = Shipping.getNickName();
            bi.OrderID = Shipping.getOrderID();
            bi.Phone = Shipping.getPhone();
            bi.Prefix = Shipping.getPrefix();
            bi.State = Shipping.getState();
            bi.Zip = Shipping.getZip();
            db.lc_ShippingInfoTables.InsertOnSubmit(bi);
            db.SubmitChanges();
